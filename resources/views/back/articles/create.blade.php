	...
	<div class="card-body">
		...
		<form method="POST" action="{{route('admin.makaleler.store')}}" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" value="{{old('title')}}" name="title" class="form-control" required></input>
			</div>  
			<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea id="editor" name="content" class="form-control" rows="4">{{old('content')}}</textarea>
