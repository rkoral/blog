	...
	<div class="card-body">
		...
		<form method="POST" action="{{route('admin.makaleler.update', $article->id)}}" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" value="{{$article->title}}" name="title" class="form-control" required></input>
			</div>  
			<div class="form-group">
				...
				<div class="form-group">
					...
					<img src="{{url('/storage/uploads/', $article->image)}}" class="img-thumbnail" width="200">
